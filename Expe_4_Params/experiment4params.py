...
perfs_analyzer.compare_adjusted(adj_types=[perfeval.EvalType.ADJUSTED, perfeval.EvalType.FOCUS_EXTREME_ON_TIME, perfeval.EvalType.TIME_ONLY])
#perfs_analyzer.compare_adjusted(adj_types=[perfeval.EvalType.ADJUSTED, perfeval.EvalType.ERROR_ONLY, perfeval.EvalType.ERROR_ONLY_2])
...
# edd.all_perfs_histogram(expe4, perf_eval_type=perfeval.EvalType.ERROR_ONLY)
# edd.all_perfs_histogram(expe4, perf_eval_type=perfeval.EvalType.ERROR_ONLY_2)
edd.all_perfs_histogram(expe4, perf_eval_type=perfeval.EvalType.FOCUS_EXTREME_ON_TIME)
edd.all_perfs_histogram(expe4, perf_eval_type=perfeval.EvalType.TIME_ONLY)
...
# edd.plot_all_perfs_per_synth(expe4, perf_eval_type=perfeval.EvalType.ERROR_ONLY)
# edd.plot_all_perfs_per_synth(expe4, perf_eval_type=perfeval.EvalType.ERROR_ONLY_2)
edd.plot_all_perfs_per_synth(expe4, perf_eval_type=perfeval.EvalType.FOCUS_EXTREME_ON_TIME)
edd.plot_all_perfs_per_synth(expe4, perf_eval_type=perfeval.EvalType.TIME_ONLY)
# edd.plot_all_perfs_histograms_by_synth(expe4, display_tests=True)  # also displays Wilcoxon signed rank tests
edd.plot_all_perfs_histograms_by_synth(expe4, perf_eval_type=perfeval.EvalType.TIME_ONLY, display_tests=True)
...
# edd.fit_perf_vs_expertise(expe4, perf_eval_type=perfeval.EvalType.ERROR_ONLY)
# edd.fit_perf_vs_expertise(expe4, perf_eval_type=perfeval.EvalType.ERROR_ONLY_2)
edd.fit_perf_vs_expertise(expe4, perf_eval_type=perfeval.EvalType.FOCUS_EXTREME_ON_TIME)
edd.fit_perf_vs_expertise(expe4, perf_eval_type=perfeval.EvalType.TIME_ONLY)

...
subject_index = 10  # -1 to disable per-subject data visualization
...
perfs_analyzer.compare_adjusted(adj_types=[perfeval.EvalType.ADJUSTED, perfeval.EvalType.FOCUS_ON_ERROR, perfeval.EvalType.INGAME])
